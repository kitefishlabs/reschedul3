(ns sand-compass.routes.services.user
  (:require [sand-compass.middleware.cors :refer [cors-mw]]
            [sand-compass.middleware.token-auth :refer [token-auth-mw]]
            [sand-compass.middleware.authenticated :refer [authenticated-mw]]
            [sand-compass.route-functions.user.user :refer :all]
            [sand-compass.route-functions.user.create-user :refer [create-user-response]]
            [sand-compass.route-functions.user.delete-user :refer [delete-user-response]]
            [sand-compass.route-functions.user.modify-user :refer [modify-user-response modify-user-state-response]]
            [schema.core :as s]
