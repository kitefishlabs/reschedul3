...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    watch: {
      ...
      files: ["build/less/*.less", "build/less/skins/*.less", "public/js/reschedul2.js"],
      tasks: ["less", "uglify"]
    },
    ...
    less: {
      ...
      development: {
        ...
        files: {
          ...
          "public/css/AdminLTE.css": "build/less/AdminLTE.less",
      ...
      production: {
        ...
        files: {
          // compilation.css  :  source.less
          "public/css/AdminLTE.min.css": "build/less/AdminLTE.less",
          // Skins minified
    ...
    uglify: {
      ...
      my_target: {
        files: {
          'public/js/reschedul2.min.js': ['public/js/reschedul2.js']
        }
      }
    },
